...
const Subscribe = () => {
  return (
    <section className="py-16 pl-28 text-white bg-black ">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="pb-12 md:mb-0 flex flex-col flex-1 overflow-visible z-[2]">
          ...
          <div className="relative w-full mt-5">
            <div className="relative w-full text-lg">
              ...
              />
              <button className="flex items-center justify-center cursor-pointer bg-yellow-500 text-xl text-white font-semibold px-20 py-6 h-14 rounded-lg absolute top-0 right-[-60%] w-fit">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-2 relative">
          <div className="absolute top-0 left-0 w-[60%] h-full bg-gradient-to-r from-black via-90% via-black/50 to-transparent" />
          <Image
            src={subscribeBg}
            alt=""

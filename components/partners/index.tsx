...
const Partners = () => {
  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-visible">
      ...
      <div
        ref={leftHalfRef}
        className="absolute w-1/2 bg-black flex items-center justify-end z-[11] overflow-visible "
      >
        <Image src={buildingfLf} alt="Mudenda Capital" />
        <div
          ref={paragraphRef}
          className="absolute left-[80%] top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#252826]/95 p-8 backdrop-blur-sm w-[90%]"
        >
          <div className="p-8">
      ...
      >
        <section className="py-20 px-6 flex justify-center relative path-trigger transition-opacity duration-700">
